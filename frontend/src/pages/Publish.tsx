        ...
        <div className="flex justify-center w-full pt-8">
            <div className="max-w-screen-lg w-full">
                <div className="pb-3">
                    ...
                    } type="text" aria-describedby="title-for-blog"  className="bg-gray-50 p-4 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Title"></input>
                </div>
                <div>
                    <TextEditon onChange={(e)=>{
...
function TextEditon( {onChange} : {onChange : (e :ChangeEvent<HTMLTextAreaElement>)=> void }) {
    return (<>
        <form>
            <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 ">
                <div className="flex items-center justify-between px-3 py-2 border-b ">
                    <div className="flex flex-wrap items-center divide-gray-200 sm:divide-x sm:rtl:divide-x-reverse ">
                        ...
                        <div className="flex flex-wrap items-center space-x-1 rtl:space-x-reverse sm:ps-4">
                            ...
                            <button type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 ">
                                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                </svg>
                ...
                <div className="px-4 py-2 bg-white rounded-b-lg">
                    ...
                    <textarea onChange={onChange} id="editor" rows={12} className="block w-full px-0 text-md text-gray-800 bg-white border-0 " placeholder="Write about your blog ..." required ></textarea>
                </div>
            </div>
        </form>
    </>)
